...
// import Students from "../assets/lmspic3.jpg";
...
//                     <StyledText>
//                         Streamline School Operations, Enhance Learning Experiences, and Empower Education—All in One Place!
//                         </StyledText>
//                     </p>
//                   </div>
//                 </div>
...
//                     </div>
//                     <h6 className="text-xl font-semibold">Log In here!</h6>
...
//                     Click to log in and access your learning journey. 🚀 Secure, fast, and just one step away from knowledge!                    </p>
//                   </div>
//                 </div>
//               </div>
...
//                     </StyledText>
//                     <p className="mt-2 mb-4 text-gray-600">
//                     Create your account and start your learning adventure today! 🚀📚                    </p>
//                   </div>
//                 </div>
//               </div>
...
//                     </h6>
//                     <p className="mt-2 mb-4 text-gray-600">
//                     "Learning is an adventure! 🌟 With our LMS, every lesson is a new discovery. Explore, grow, and achieve your dreams—one click at a time! 🚀📚"</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
import styled from 'styled-components';
import Students from "../assets/lmspic3.jpg";
import schoolpic from "../assets/schoolpicn1.jpg"
import { LightPurpleButton } from '../components/buttonStyles';
...
export default function Landing() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setResponseMessage("Failed to submit appointment. Please try again.");
    }
        ...
        <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center lg:-mt-64 -mt-48">
              <div className="w-full lg:w-6/12 px-4">
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-300">
                  <div className="flex-auto p-5 lg:p-10">
                    <h4 className="text-2xl font-semibold">Want to enroll your child?</h4>
                    <p className="leading-relaxed mt-1 mb-4 text-gray-600">
                      Complete this form and we will get back to you in 24 hours.
                    </p>
                    ...
                    <div className="p-6 bg-white shadow-lg rounded-lg mt-10">
                      ...
                      <form onSubmit={handleSubmit} className="max-w-lg mx-auto mt-6">
                        ...
                        {responseMessage && <p className="text-sm text-green-600 mb-2">{responseMessage}</p>}
